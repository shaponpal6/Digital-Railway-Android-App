...
public class AddTrainTrackingAdapter extends ArrayAdapter {
    ...
    public AddTrainTrackingAdapter(Context context, int resource, List<String> storeDataLst) {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        TextView strName = (TextView) view.findViewById(R.id.trainName);
