...
import com.shopnobuilder.digitalrailway.tracking.viewTracking.ViewTrackingClass;

public class ViewTrackingActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_view_tracking, menu);
        return true;
    }
...
//        b.setTag(R.id.track, "something");
        ...
        Intent intent = new Intent(ViewTrackingActivity.this, SMSTrackingActivity.class);
        intent.putExtra("TrainNo", trainNO );
        startActivity(intent);

        Toast.makeText(ViewTrackingActivity.this, trainNO, Toast.LENGTH_LONG).show();
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_view_tracking, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    ViewTrackingClass viewTrackingClass = new ViewTrackingClass();
                    return viewTrackingClass;
                case 1:
