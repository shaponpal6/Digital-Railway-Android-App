...
import com.shopnobuilder.digitalrailway.filterTabView.filter.byTrainNumber.FilterByTrainNumberAdapter;
...
public class FilterByTrainNumber extends Fragment {
    SearchView sv;
    ArrayList<Train> trains = new ArrayList<>();

    FilterByTrainNumberAdapter byTrainNumberAdapter;

    public FilterByTrainNumber() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //ADAPTER
        byTrainNumberAdapter = new FilterByTrainNumberAdapter(getContext(), this.trains);
        rv.setAdapter(byTrainNumberAdapter);
        ...
        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                //FILTER AS YOU TYPE
                byTrainNumberAdapter.getFilter().filter(query);
                return false;
            }
        });
        //------------- Filter Code ------------
