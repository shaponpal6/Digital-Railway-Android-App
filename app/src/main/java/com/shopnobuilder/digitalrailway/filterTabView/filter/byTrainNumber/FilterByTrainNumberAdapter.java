...
public class FilterByTrainNumberAdapter extends RecyclerView.Adapter<TrainViewHolder> implements Filterable {

    Context c;
    ArrayList<Train> trains, filterList;
    ByTrainNumberFilter filter;



    public FilterByTrainNumberAdapter(Context ctx, ArrayList<Train> trains) {
        this.c = ctx;
        this.trains = trains;
    ...
    public Filter getFilter() {
        if (filter == null) {
            filter = new ByTrainNumberFilter(filterList, this);
        }
