...
import com.shopnobuilder.digitalrailway.filterTabView.filter.byStation.FilterByStationNameAdapter;
 ...
 */
public class FilterByStationName extends Fragment {
    SearchView sv;
    ArrayList<Train> trains = new ArrayList<>();
    FilterByStationNameAdapter byStationNameAdapter;
    MyAdapter adapter;

    String json_file = "file:///android_asset/itbg.json";

    public FilterByStationName() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.find_train_by_station_name, container, false);
        ...
        //ADAPTER
        byStationNameAdapter = new FilterByStationNameAdapter(getContext(), this.trains);
        rv.setAdapter(byStationNameAdapter);
        ...
        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                //FILTER AS YOU TYPE
                byStationNameAdapter.getFilter().filter(query);
                return false;
            }
        });
        //------------- Filter Code ------------
